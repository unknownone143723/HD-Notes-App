...
// --- HELPER COMPONENTS (reused from your SignupPage) ---
const EyeIcon = () => (
...
const InputField = ({ name, type, label, value, onChange, icon, disabled = false, required = true }: any) => (
    <div className="relative">
        <input
            ...
            placeholder=" " required={required} disabled={disabled}
        />
        <label
            htmlFor={name}
...
const LoginPage = () => {
    ...
    return (
        <div className="">
            <div className="w-full max-w-4xl md:h-[575px] mx-auto bg-white rounded-2xl shadow-xl flex">
                <div className="w-full lg:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
                    ...
                    {loginMethod === 'password' ? (
                        <form onSubmit={handlePasswordLogin} className="space-y-6">
                            ...
                            <InputField 
                                name="password" type={showPassword ? 'text' : 'password'} label="Password" value={password}
